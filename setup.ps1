...
#
# build-exe.bat calls this with -ToolsOnly to get Tesseract and Poppler without
# the .venv-win, which the standalone build does not use.
...
if ($ToolsOnly) {
    Write-Ok 'Skipped - build-exe.bat makes its own build environment.'
